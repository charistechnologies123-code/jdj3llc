...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('SUBMITTED', 'CONTACTED', 'CANCELLED', 'FULFILLED');

-- CreateEnum
CREATE TYPE "ReviewStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "ReferralStatus" AS ENUM ('REGISTERED', 'ORDERED');
...
CREATE TABLE "Product" (
    ...
    "requestPriceLabel" TEXT NOT NULL DEFAULT 'Request Price',
    "isActive" BOOLEAN NOT NULL DEFAULT true,
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_referredByUserId_fkey" FOREIGN KEY ("referredByUserId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
